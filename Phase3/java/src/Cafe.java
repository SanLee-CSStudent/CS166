...
// Rest of the functions definition go in here
   ...
   // 	search certain menus by itemName or by type of drinks
   // managers-specific:
   //	add/delete/update items in menu
   public static void Menu(Cafe esql){}
   
   // update profile searched through user interface with numbers
   // managers can select certain user to update their profile
   ...
   // orders should be searched by typing in OrderID
   //	managers and employees can change order to "paid"
   // browse the order history made by this user(show the 5 most recent)
   // employees can see all orders within 24 hours that are unpaid
